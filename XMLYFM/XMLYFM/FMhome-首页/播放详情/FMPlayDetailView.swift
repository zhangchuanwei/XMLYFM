...
class FMPlayDetailView: UIView {
    ...
    func setUpUI(){
        ...
        visuaEffectView.frame = self.blurImageView.bounds
        
        self.blurImageView.addSubview(visuaEffectView)
        self.blurImageView.backgroundColor = UIColor.red
        self.insertSubview(self.blurImageView, belowSubview: self) // 放在self的下面
